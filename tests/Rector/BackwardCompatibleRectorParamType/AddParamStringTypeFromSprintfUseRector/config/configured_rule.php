...
return static function (RectorConfig $rectorConfig): void {
    ...
    if (class_exists('Rector\TypeDeclaration\Rector\ClassMethod\AddParamStringTypeFromSprintfUseRector::class')) {
        $rectorConfig->rule(\Rector\TypeDeclaration\Rector\ClassMethod\AddParamStringTypeFromSprintfUseRector::class);
        $rectorConfig->skip([\Rector\TypeDeclaration\Rector\ClassMethod\AddParamStringTypeFromSprintfUseRector::class]);
    }
};
