...
return static function (RectorConfig $rectorConfig): void {
    ...
    if (class_exists('Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromStrictParamRector')) {
        $rectorConfig->rule(\Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromStrictParamRector::class);
        $rectorConfig->skip([\Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromStrictParamRector::class]);
    }
};
