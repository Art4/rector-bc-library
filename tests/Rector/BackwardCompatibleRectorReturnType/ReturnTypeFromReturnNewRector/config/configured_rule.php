...
return static function (RectorConfig $rectorConfig): void {
    ...
    if (class_exists('Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromReturnNewRector')) {
        $rectorConfig->rule(\Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromReturnNewRector::class);
        $rectorConfig->skip([\Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromReturnNewRector::class]);
    }
};
