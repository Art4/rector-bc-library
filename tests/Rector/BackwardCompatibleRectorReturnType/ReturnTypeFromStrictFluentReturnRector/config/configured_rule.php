...
return static function (RectorConfig $rectorConfig): void {
    ...
    if (class_exists('Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromStrictFluentReturnRector')) {
        $rectorConfig->rule(\Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromStrictFluentReturnRector::class);
        $rectorConfig->skip([\Rector\TypeDeclaration\Rector\ClassMethod\ReturnTypeFromStrictFluentReturnRector::class]);
    }
};
