...
return static function (RectorConfig $rectorConfig): void {
    ...
    if (class_exists('Rector\TypeDeclaration\Rector\ClassMethod\BoolReturnTypeFromBooleanConstReturnsRector')) {
        $rectorConfig->rule(\Rector\TypeDeclaration\Rector\ClassMethod\BoolReturnTypeFromBooleanConstReturnsRector::class);
        $rectorConfig->skip([\Rector\TypeDeclaration\Rector\ClassMethod\BoolReturnTypeFromBooleanConstReturnsRector::class]);
    }
};
